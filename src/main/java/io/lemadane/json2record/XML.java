...
public final class XML {
     ...
     * @throws io.lemadane.json2record.exceptions.XmlMappingException for structural, conversion, or mapping errors.
     */
     ...
     * @throws NullPointerException if any argument is null.
     * @throws RecordConstructionException if recordType is not a Java record class.
     * @throws io.lemadane.json2record.exceptions.XmlMappingException for conversion or mapping errors.
     */
     ...
     * @throws io.lemadane.json2record.exceptions.XmlMappingException if stringification fails.
     */
